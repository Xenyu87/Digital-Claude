...
def render_dashboard_header(report: dict[str, object], monitored_project: object, auto_pilot_json: dict[str, object]) -> str:
    return f"""
  <header>
...
def render_dashboard_tabs() -> str:
    ...
    buttons = "\n      ".join(
        f'<button class="tab-button{active}" type="button" data-dashboard-tab="{key}">{label}</button>'
...
def render_guidance_cards(guidance_items: list[dict[str, object]]) -> str:
    return "".join(
...
def render_home_section(
    ...
    monitored_project: object,
    auto_pilot_json: dict[str, object],
    pr_json: dict[str, object],
    warning_tasks: list[object],
    findings_count: object,
    new_count: object,
    nodes_checked: object,
    guidance_html: str,
) -> str:
    return f"""
...
def render_automation_section(
    background_json: dict[str, object],
    runner_json: dict[str, object],
...
def render_actions_section(
    ...
    action_pack_json: dict[str, object],
    validate: dict[str, object],
    self_test: dict[str, object],
    sync_check: dict[str, object],
    analytics: dict[str, object],
    background_json: dict[str, object],
    auto_pilot_json: dict[str, object],
    pr_json: dict[str, object],
    copilot_json: dict[str, object],
    agent_json: dict[str, object],
    event_log: dict[str, object],
    expert_feedback_json: dict[str, object],
    monitored_project: object,
    docs_json: dict[str, object],
) -> str:
    return f"""
...
def render_diagnostics_section(
    project_memory: dict[str, object],
    skill_learning: dict[str, object],
    event_log: dict[str, object],
    maintenance_json: dict[str, object],
    project_audit: dict[str, object],
    git: dict[str, object],
    ...
    self_test: dict[str, object],
    sync_check: dict[str, object],
    context_scan: dict[str, object],
    skill_intake: dict[str, object],
    bootstrap_preview: dict[str, object],
    docs_audit: dict[str, object],
    pr_readiness: dict[str, object],
...
{render_actions_section(report, active_task, action_pack_json, validate, self_test, sync_check, analytics, background_json, auto_pilot_json, pr_json, copilot_json, agent_json, event_log, expert_feedback_json, monitored_project, docs_json)}
{render_diagnostics_section(project_memory, skill_learning, event_log, maintenance_json, project_audit, git, files, sessions, analytics, validate, self_test, sync_check, context_scan, skill_intake, bootstrap_preview, docs_audit, pr_readiness, checks, report)}
