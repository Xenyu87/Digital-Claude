        ...
        flow_nodes.append(
            {
                ...
                "uiRole": str(item.get("ui_role") or ""),
                "actionDescription": str(item.get("action_description") or ""),
                "subnodes": item.get("subnodes") if isinstance(item.get("subnodes"), list) else [],
                "x": x,
                "y": y,
