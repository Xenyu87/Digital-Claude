...
- 2026-06-15 — SKILL.md §3 + skill-sync.md + maintenance-compaction.md — novità CLI giu 2026: `fallbackModel`/`--fallback-model` (≥2.1.166) come rete anti-blocco escalation; `/reload-skills` (≥2.1.152) post sync_skill.py senza riavvio; `--safe-mode` (≥2.1.169) e Stop-hook block cap (≥2.1.147, `CLAUDE_CODE_STOP_HOOK_BLOCK_CAP`) per troubleshooting skill/hook/plugin
